...
: G4VUserPrimaryGeneratorAction(),spectrum("off")
{
  ...
  // default particle kinematic
   ...
   fpParticleGun->SetParticleEnergy(0.2*MeV);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  G4cout<<"Direção "<<fpParticleGun->GetParticleMomentumDirection()<<G4endl;
  G4cout<<"Posição "<<fpParticleGun->GetParticlePosition()<<G4endl;
  G4cout<<"Particula "<<fpParticleGun->GetParticleDefinition()->GetParticleName() <<G4endl;
